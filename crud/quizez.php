...
if ($method === "POST") {
    ...
    $query = "INSERT INTO quiz (question, option_1,option_2,option_3,option_4,correct_answer) VALUES (?, ?, ?, ?, ?, ?)";
...
if ($method === "PUT") {
    ...
    $query = "UPDATE quiz SET question = ?, option_1 = ?, option_2 = ?, option_3 = ?, option_4 = ?, correct_answer = ? WHERE id = ?";
    $stmt = $connection->prepare($query);
